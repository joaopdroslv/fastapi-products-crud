...
expected_status = ['em_estoque', 'em_reposicao']  # Status necessários para gerar produtos válidos
    ...
    return [
        {
            ...
            'description': data_faker.sentence()[:255],  # Limita a quantidade de carcteres
            'price': round(data_faker.pyfloat(min_value=10, max_value=5000, right_digits=2), 2),
